...
public class RoomsServiceConnection
{
    ...
    public async Task<(SharedApiUtils.ServicesAccessing.Protos.Rooms.RoomsClient? client, Metadata? headers)> GetClient()
    {
        try
        {
            ...
            var client = new SharedApiUtils.ServicesAccessing.Protos.Rooms.RoomsClient(chanel);
